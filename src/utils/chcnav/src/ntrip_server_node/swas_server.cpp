...
swas_int32_t swas_server::connect(swas_void_t)
{
    ...
    if (this->swas_status.load() == SWAS_TRUE)
    {
    ...
    do
    {
        ...
        if (this->socket_connect_flag.load() == SWAS_TRUE)
        {
    ...
    if (this->sdk_config.login_type != SWAS_SDK_LOGIN_TYPE_THIRD_CORS)
    {
        ...
        do
        {
            ...
            if (this->calib_success_flag.load() == SWAS_TRUE &&
                this->socket_connect_flag.load() == SWAS_TRUE)
            {
    ...
    do
    {
        if (this->auth_success_flag.load() == SWAS_TRUE)
        {
    ...
    this->swas_status.store(SWAS_TRUE);
