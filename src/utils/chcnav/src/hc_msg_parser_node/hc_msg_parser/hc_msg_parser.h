...
typedef enum _hc__scan_result_e
{
    HC__SCAN_ERROR = -1,
    HC__SCAN_TOKEN = 0,
    HC__SCAN_NO_DATA = 1
...
/** Release the working buffer allocated by hc__init_msg_parser(). */
 ...
 *
 * @returns @c HC__SCAN_TOKEN if a token was produced,
 *          @c HC__SCAN_NO_DATA if the source currently has no bytes,
 *          or @c HC__SCAN_ERROR on error.
 */
