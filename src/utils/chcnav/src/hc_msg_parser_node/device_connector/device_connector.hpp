#ifndef CHCNAV_DEVICE_CONNECTOR_HPP_
#define CHCNAV_DEVICE_CONNECTOR_HPP_

class hc__device_connector
{
public:
    virtual ~hc__device_connector() = default;
     ...
     */
    virtual int write(const char *data, unsigned int len) = 0;
...
#endif  // CHCNAV_DEVICE_CONNECTOR_HPP_
