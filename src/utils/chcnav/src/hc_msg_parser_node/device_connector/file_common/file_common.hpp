#ifndef CHCNAV_FILE_COMMON_HPP_
#define CHCNAV_FILE_COMMON_HPP_
...
class file_common final : public hc__device_connector
{
private:
...
public:
    ...
    int write(const char *data, unsigned int len) override
    {
        ...
        return fwrite(reinterpret_cast<const unsigned char *>(data), 1, len, this->fp);
    }
     ...
     */
    ~file_common() override { this->disconnect(); }
};

#endif  // CHCNAV_FILE_COMMON_HPP_
